<div class="w-60 h-full shadow-md bg-custom-gray absolute py-4">
  <ul class="mt-16 relative">
    ...
    <li class="mt-2 relative">
        <a class="flex items-center text-sm py-3 px-6 h-12 overflow-hidden {{ $activeNavItem === 'passwords' ? 'bg-custom-green text-white  hover:bg-custom-green  font-bold' : 'text-white hover:text-gray-900 hover:bg-gray-100' }}    text-ellipsis whitespace-nowrap hover:text-gray-900 hover:font-bold transition duration-300 ease-in-out" href="{{ route('user.password') }}" data-mdb-ripple="true" data-mdb-ripple-color="dark">
