...
<main class="py-16 flex justify-center">
    <div class="w-8/12">
    <div class="mt-4 text-2xl font-bold text-custom-gray"> Edit card</div>
    ...
    <label class="block text-custom-gray font-bold mt-3  max-w-2xl" for="card_number">Card Number<label>
            <input type="text" placeholder="1234 5678 9012 3456" maxlength="19" value="{{ $card->card_number }}"
    ...
    <div>
    <div class="flex mt-8">
         <button class="px-6 py-4 focus:ring-4 focus:ring-blue-300 bg-green-500 text-white rounded font-bold mt-3">Update card</button>
    </div>
    </div>
