...
<body class="bg-white md:bg-custom-gray lg:bg-custom-gray min-h-screen flex flex-col items-center justify-center">
    <div class="bg-white md:bg-white shadow-0 md:shadow-lg lg:shadow-lg lg:bg-white  w-full max-w-lg p-8 mb-8">
        <div class="flex flex-col items-center">
            <div class="flex justify-center">
                <a href="https://www.zacl.co.zm/"><img src="/front-logo.png" alt="logo" /></a>
            </div>
            <h3 class="mt-9 text-2xl font-bold text-center text-custom-gray">Welcome to Zambia Airports Corporation Limited Portal</h3>
            <p class="mt-2 text-center  text-custom-gray ">
                Access your account and manage your payments conveniently
                and securely.
            </p>
        </div>
        <form method="POST" action="{{ route('login.custom') }}">
            ...
            <div class="mt-6">
                <div>
                    <label class="block text-custom-gray md:text-custom-gray lg:text-custom-gray font-bold" for="email">Email<label>
                ...
                <label class="mt-4 block text-custom-gray md:text-custom-gray lg:text-custom-gray font-bold" for="email">Password</label>
                ...
                <div class="mt-4 w-full justify-center text-sm text-center text-custom-gray md:text-blue-600 lg:text-blue-600 font-normal">
                    Forgot your password ? <a href="{{ route('forgot') }}" class="text-blue-600 lg:text-blue-600 hover:underline font-bold">Reset Password</a> if you don't have an account <a href="{{ route('register-user') }}" class="text-blue-600 lg:text-blue-600 hover:underline font-bold">Create Account</a>
                </div>
            </div>
        </form>
