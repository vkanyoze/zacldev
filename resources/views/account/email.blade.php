...
@section('content')
@include('header')
@include('side-bar', ['activeNavItem' => 'email'])
    <form action="{{ route('user.email') }}" method="POST">
    @csrf
<main class="py-16 flex justify-center">
    <div class="w-8/12">
    <div class="mt-4 text-2xl font-bold text-custom-gray"> Update email address</div>
    ...
    <div class="flex mt-8">
         <button class="px-6 py-4 bg-green-500 text-white rounded font-bold mt-3">Change email</button>
    </div>
    </div>
</form>
<script>
