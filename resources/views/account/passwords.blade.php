...
<div class="flex-grow flex">
    @include('new-side-bar',  ['activeNavItem' => 'password'])
    <main class="w-screen text-gray-700">
        <div class="w-full sm:w-full lg:w-8/12 md:w-full p-6 sm:p-6 md:p-8 lg:p-12">
            ...
            <div class="flex justify-between items-center max-w-2xl">
                <div class="text-2xl font-bold text-custom-gray">Update your password</div>
            </div>
            ...
            <div>
                <form action="{{ route('password.change') }}" method="POST">
                    ...
                    <div class="flex mt-8">
                        <button class="px-6 py-4 bg-green-500 text-white rounded font-bold mt-3 w-full sm:w-full lg:w-auto md:w-auto">Change Password</button>
                    </div>
                    </div>
                </form>
        </div>
