...
<div class="flex-grow flex">
    ...
    <main class="w-screen text-gray-700">
        <div class="w-full sm:w-full lg:w-8/12 p-6 sm:p-6 md:p-8 lg:p-12">
             <div class="block h-16 w-full bg-white md:hidden lg:hidden"></div>
            <div class="flex justify-between items-center max-w-2xl">
                <div class="text-2xl font-bold text-custom-gray">Confirm transaction</div>
                <div class="font-semibold text-base">Step 3 of 3</div>
            </div>
            ...
            <div class="flex max-w-2xl mt-5">
                ...
                <div class="flex-1 w-64 ml-2 font-bold text-custom-gray">
                    {{ $invoice['currency']}} {{ $invoice['amount_spend']}}
                </div>
            </div>
            ...
            <div class="flex mt-8">
                ...
                <button class="px-6 py-4 bg-green-500 text-white rounded font-bold mt-3 w-full sm:w-full lg:w-auto md:w-auto">Proceed to Pay</button>
            </div>
            </form>
        </div>
    </main>
