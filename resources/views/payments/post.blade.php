...
<main class="py-16 flex justify-center">
    ...
    <div class="flex mt-8">
         <button class="px-6 py-4 focus:ring-4 focus:ring-blue-300 bg-white rounded font-bold mt-3 mr-4 text-custom-gray border border-custom-gray" id="btns">Add another payment</button>
