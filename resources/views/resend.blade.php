...
<body class="bg-white md:bg-custom-gray lg:bg-custom-gray min-h-screen flex flex-col items-center justify-center">
    <div class="bg-white shadow-0 md:shadow-lg lg:shadow-lg lg:bg-white  w-full max-w-lg p-8 mb-8">
        <div class="flex flex-col items-center">
            ...
            <h3 class="mt-9 text-2xl font-bold text-center text-custom-gray lg:text-custom-gray">Resend your Email Verification</h3>
            <p class="mt-2 text-center text-custom-gray lg:text-custom-gray">
                Securely resend your email Verification and regain access to your account.
            </p>
        </div>
        <form method="POST" action="{{ route('resend-verification-email') }}">
            ...
            <div class="mt-6">
                ...
                Don't have an account? <a href="{{ route('register-user') }}" class="text-blue-600 lg:text-blue-600 hover:underline font-bold">Create Account</a> if you already have an account <a href="{{ route('login') }}" class="text-blue-600 lg:text-blue-600 hover:underline font-bold">Sign in here</a>
                </div>
            </div>
        </form>
